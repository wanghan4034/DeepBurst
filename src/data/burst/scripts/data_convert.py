...
meta_data['k_on'] = meta_data['bf']
meta_data['bs'] = meta_data['k_syn']/meta_data['k_off']
meta_data['bf'] = meta_data['k_on']*meta_data['k_off']/(meta_data['k_on']+meta_data['k_off'])
...
meta_data['mean_label'] = meta_data.apply(lambda row: 1 if row['mean'] > mean_median else 0, axis=1)
...
meta_data.to_csv(os.path.join(saved_dir,f'meta_data_{eid}.csv'),index=False)
