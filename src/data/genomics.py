...
from src.data.constants import GENOMIC_FASTA_PATH
from src.data.basic import GenomicSite,  GenomicSlice, CREsInfo, GeneInfo, TranscriptInfo, TranscriptStartSite, FragData
