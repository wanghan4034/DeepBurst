...
do  
    ...
    python train.py --config configs/default.yaml --meta extra/datasets/processed/v1/train.csv  --npy-dir /GPUFS/sysu_jjzhang_3/wanghan/burstformer/extra/datasets/processed/v1 --fold $fold  -o checkpoints/agnostic.$fold.No_feature_bin.bs_bf_para.model.pt --exp-id 2 --binsizes 500 > logs/agnostic.$fold.No_feature_bin.bs_bf_para.train.log 2>&1
    sleep 120
done
