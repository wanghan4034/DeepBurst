...
npy_dir = "extra/datasets/processed/v1/random_seq_enformer_prediction/regions"
...
for eid in ["E003"]:
    for fold in [0,1,2,3]:
        ...
        for target in targets:
            ...
            val_pred = val_preds[target].argmax(axis=1)
...
predictions.to_csv(f'extra/results/predictions_bs_bf_from_random_seq_enformer_output.csv',index=False)
