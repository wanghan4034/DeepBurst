...
npy_dir = "extra/datasets/processed/v1/E003_enformer"
...
for eid in ["E003"]:
    for fold in [0,1,2,3]:
        ...
        val_dataset = EnformerDataset(meta_path,val_genes,npy_dir, targets=targets, binsizes=[2000, 500, 100])
...
predictions.to_csv(f'extra/datasets/benchmark/Promoterformer/results/predictions_bs_bf_from_enformer_output.csv',index=False)
