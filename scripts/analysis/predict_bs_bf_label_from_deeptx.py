...
if remove_marks:
    predictions.to_csv(f'extra/datasets/results/remove_{remove_marks}_predictions_bs_bf_deeptx.csv',index=False)
else:
    predictions.to_csv(f'extra/datasets/results/predictions_bs_bf_deeptx.csv',index=False)
