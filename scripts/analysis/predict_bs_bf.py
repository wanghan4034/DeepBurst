...
if remove_marks:
    predictions.to_csv(f'extra/results/remove_{remove_marks}_predictions_bs_bf.csv',index=False)
else:
    predictions.to_csv(f'extra/results/predictions_bs_bf.csv',index=False)
