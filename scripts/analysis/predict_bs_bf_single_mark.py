...
for eid in ["E116","E118","E003"]:
    for mark in MARKS:
        ...
        for fold in [0,1,2,3]:
            ...
            checkpoints = f"benchmark/Promoterformer/checkpoints/{eid}.remove_{tag}.{fold}.No_feature_bin.bs_bf_para.model.pt"
...
predictions.to_csv(f'extra/datasets/benchmark/Promoterformer/results/single_mark_predictions_bs_bf.csv',index=False)
