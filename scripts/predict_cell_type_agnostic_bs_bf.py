...
with open("extra/datasets/benchmark/Promoterformer/results/valid.csv",'w') as w:
    ...
    for eid in ["E116","E118","E003"]:
        for fold in [0,1,2,3]:
            ...
            checkpoints = f"benchmark/Promoterformer/checkpoints/agnostic.{fold}.No_feature_bin.model.pt"
