...
from benchmark.Promoterformer.constants import MARKS, PERTURBARION_STRENGTH, PERTURBARION_REGION
...
for eid in ["E116","E118","E003"]:
    ...
    for masked_mark in keep_marks:
        config['masked_marks'][masked_mark] = {PERTURBARION_REGION:marked_bin_idxes, PERTURBARION_STRENGTH:1}
    ...
    for perturbation_strength in range(11):
        for masked_mark in keep_marks:
            config['masked_marks'][masked_mark][PERTURBARION_STRENGTH] = perturbation_strength * 0.1
